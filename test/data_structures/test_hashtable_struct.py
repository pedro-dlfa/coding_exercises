...
def test_hashtable__add_get_element__ok(faker):
    sut = HashTable()
...
def test_hashtable__add_get_element_brackets_syntax__ok(faker):
    sut = HashTable()
    in_key = random.randrange(1000)
    in_value = faker.pystr()
...
def test_hashtable__get_non_existing_element_no_default_provided__none_returned(faker):
    sut = HashTable()
    in_key = random.randrange(1000)
...
def test_hashtable__get_non_existing_element_without_default_provided__none_returned(
    faker,
):
    sut = HashTable()
    in_key = random.randrange(1000)
...
def test_hashtable__get_non_existing_element_brackets_syntax__key_error(faker):
    sut = HashTable()
    in_key = random.randrange(1000)
...
def test_hashtable__check_contains_existing_element__true(faker):
    sut = HashTable()
    in_key = random.randrange(1000)
...
def test_hashtable__check_contains_existing_element__false(faker):
    sut = HashTable()
    in_key = random.randrange(1000)
...
def test_hashtable__remove_non_existing_element__key_error(faker):
    sut = HashTable()
    in_key = random.randrange(1000)
...
def test_hashtable__remove_existing_element__ok(faker):
    sut = HashTable()
    in_key = random.randrange(1000)
...
def test_hashtable__remove_non_existing_element_del_syntax__key_error(faker):
    sut = HashTable()
    in_key = random.randrange(1000)
...
def test_hashtable__remove_existing_element_del_syntax__ok(faker):
    sut = HashTable()
    in_key = random.randrange(1000)
...
def test_hashtable__check_collisions__ok(faker):
    initial_size = 10
...
def test_hashtable__test_resize__ok(faker, mocker):
    initial_size = 10
    keys = [
